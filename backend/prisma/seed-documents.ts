...
const TEMPLATES: SeedTemplate[] = [
  {
    ...
    fields: [
      { name: 'agreementDate', label: 'Agreement date', type: 'date', section: 'Basics' },
      { name: 'city', label: 'City', type: 'text', section: 'Basics', placeholder: 'Bengaluru' },
      { name: 'state', label: 'State', type: 'text', section: 'Basics', placeholder: 'Karnataka' },
      ...
      { name: 'monthlyRent', label: 'Monthly rent (INR)', type: 'number', section: 'Terms' },
      { name: 'securityDeposit', label: 'Security deposit (INR)', type: 'number', section: 'Terms' },
      { name: 'termMonths', label: 'Term (months)', type: 'number', section: 'Terms', placeholder: '11' },
      { name: 'startDate', label: 'Tenancy start date', type: 'date', section: 'Terms' },
      { name: 'noticePeriodDays', label: 'Notice period (days)', type: 'number', section: 'Terms', placeholder: '30' },
    ],
    body: `RESIDENTIAL RENTAL AGREEMENT
...
1. PREMISES. The Landlord lets to the Tenant the residential premises situated at
...
6. USE. The Premises shall be used for residential purposes only and shall not be
sublet without the Landlord's written consent.
