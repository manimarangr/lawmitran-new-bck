...
export class SeoController {
  ...
  @ApiOperation({
    summary:
      'URL feed (lawyer slugs, cities, practice areas) for building XML sitemaps',
  })
  sitemap() {
  ...
  @ApiOperation({
    summary:
      'Editable landing copy for a city × practice page (with generated fallback)',
  })
  getLanding(@Param('city') city: string, @Param('practice') practice: string) {
  ...
  @ApiOperation({
    summary: 'Create/update SEO copy for a city × practice landing page',
  })
  upsertLanding(
